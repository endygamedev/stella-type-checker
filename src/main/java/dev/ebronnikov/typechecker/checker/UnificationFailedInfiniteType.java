...
public final class UnificationFailedInfiniteType extends UnificationResult {
    private final Type expectedType;
    private final Type actualType;
    private final ParserRuleContext expression;

    public UnificationFailedInfiniteType(Type expectedType, Type actualType, ParserRuleContext expression) {
    ...
    public boolean equals(Object o) {
        ...
        UnificationFailedInfiniteType that = (UnificationFailedInfiniteType) o;
    ...
    public String toString() {
        return "UnificationFailedInfiniteType{" +
